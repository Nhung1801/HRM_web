...
export class AuthService {
    ...
    updateStatuEmployee(request: any = null,params:any): Observable<any> {
        return this.httpLoadingService.putBodyAndQueryParams('employee/update-account-status',params, request);
    }

    updateStatuEmployeeMultiple(request: any ): Observable<any> {
        return this.httpLoadingService.put('employee/update-range-account-status',request);
    }
